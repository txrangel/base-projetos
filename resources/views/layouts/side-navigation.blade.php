...
<label for="menu-toggle" class="fixed left-0 top-0 p-2 block md:hidden z-50 cursor-pointer">
    <div class="p-4 flex items-center justify-center transition-all duration-300 ease-in-out h-10 w-10 bg-gray-800 text-white rounded-md">
        <i class="w-4 fa-solid fa-bars"></i>
    </div>
</label> --}}

<!-- Sidebar -->
<aside class="bg-gray-900 text-white h-full fixed left-0 top-0 overflow-y-auto transition-all duration-300 ease-in-out w-12 peer-checked:w-48 md:w-48">
    ...
    <nav class="">
        <ul>
            <!-- Link para a home -->
            <li class="px-4 py-2 hover:bg-gray-800 flex items-center">
